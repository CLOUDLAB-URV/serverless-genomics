...
class PartitionFasta():
    ...
    def generate_index_file_titles(self,total_obj_size):
        ...
        chr_index = 0
        chr_subindex = 0
        obj_key = 'fasta/TriTrypDB-9.0_TbruceiTREU927_Genome_MbChr.fasta'
...
def generate_chunks_corrected_index(id,r,storage):
    ...
    obj_bucket = "genomicsdata"
    obj_key = location.split('/')[1:]
    obj_key = "fasta/TriTrypDB-9.0_TbruceiTREU927_Genome_MbChr.fasta"
    obj_name = "TriTrypDB-9.0_TbruceiTREU927_Genome_MbChr"
...
if __name__ == "__main__":
    ...
    obj = 'http://192.168.2.3:9000/genomicsdata/fasta/TriTrypDB-9.0_TbruceiTREU927_Genome_MbChr.fasta'  # Change-me
    
    my_bucket_name = 'genomicsdata' # Change-me
    fasta_key = 'fasta/TriTrypDB-9.0_TbruceiTREU927_Genome_MbChr.fasta'
    worker_chunk_size = 1000000
    ovlp = 300
