...
import argparse
from serverlessgenomics.varcall_arguments import Arguments
from serverlessgenomics.pipeline_caller import PipelineCaller
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--tolerance', help='number of additional strata to include in filtration of map file',
                        required=False)
    ...
    parser.add_argument('-s3w', '--temp_to_s3', help='Write intermediate temp files to s3 for debugging',
                        required=False)
    ...
    parser.add_argument('-rts', '--runtime_storage',
                        ...
                        required=False)
    parser.add_argument('-bs', '--buffer_size', help='memory in percentatge for buffer size - maximum 100%',
                        required=False)
    parser.add_argument('-ftm', '--func_timeout_map', help='timeout for map function - maximum 900', required=False)
    parser.add_argument('-ftr', '--func_timeout_reduce', help='timeout for reduce function - maximum 900',
                        required=False)
    ...
    parser.add_argument('-cp', '--checkpoints', help='use checkpoints for execution (true or false)', required=False)
