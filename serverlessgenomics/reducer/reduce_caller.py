...
def run_reducer(pipeline_params: PipelineParameters, lithops: Lithops, mapper_output):
    ...
    lithops = deflithops.FunctionExecutor(runtime_memory=8192)
    ...
    for fasta in intermediate_keys:
        data = {"pipeline_params": pipeline_params, "keys": intermediate_keys[fasta]}
    ...
    reducer_iterdata = create_iterdata_reducer(
        intermediate_keys, distributed_indexes, multipart_ids, multipart_keys, pipeline_params
    )
