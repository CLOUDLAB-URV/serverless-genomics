...
class AlignmentMapper:
    ...
    def map_alignment1(self, id: int, fasta_chunk: dict, fastq_chunk: str, exec_param: str, storage: Storage) -> Tuple[str]:
        """
    ...
    def map_alignment2(self, old_id: int, fasta_chunk: dict, fastq_chunk: str, corrected_map_index_file: str, filtered_map_file: str, base_name: str, exec_param: str, storage: Storage) -> Tuple[str]:
        """
    ...
    def mpileup_conversion(self, mpileup_file: str, fasta_chunk: dict, fastq_chunk: str, exec_param: str, storage: Storage) -> Tuple[str]:
        """
