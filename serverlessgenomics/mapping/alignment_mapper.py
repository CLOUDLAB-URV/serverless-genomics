...
class AlignmentMapper:
    def __init__(self, fasta_chunks_prefix: str, args: PipelineRun):
    ...
    def map_alignment1(self, id: int, fasta_chunk: dict, fastq_chunk: str, exec_param: str, storage: Storage) -> Tuple[
        str]:
        """
        ...
        Args:
            id (int): function id, generated by lithops
        ...
        sp.run(['/function/bin/map_index_and_filter_map_file_cmd_awsruntime.sh', gem_ref, fastq1, fastq2, base_name,
                self.args.datasource, self.args.seq_type], capture_output=True)
    ...
    def map_alignment2(self, old_id: int, fasta_chunk: dict, fastq_chunk: str, corrected_map_index_file: str,
