...
class MapReduce:
    ...
    def get_s3_select_indexes(self, bucket, keys, file_format):
        # Modified, s3 = boto3.client('s3', endpoint_url="http://192.168.2.3:9000", aws_access_key_id="4OXIXRDDKRHB18U87QT2", aws_secret_access_key="gRphCMTppd9GS4CYIagGnwcttMZ0i3IOs46+O7XA")
        s3 = boto3.client('s3')
